...
adb pull  /system/lib/libril.so  ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/libsecril-client.so ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/libsec-ril40.so ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/bin/rild ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/libcamera.so ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/bin/pppd_runner ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/vendor/bin/gpsd ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/vendor/etc/gps.xml  ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/hw/gps.aries.so  ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/libms3c_yamaha.so  ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/libsensor_yamaha.so  ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/libsensor_yamaha_test.so  ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/bin/sensorcalibutil_yamaha ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/bin/sensorserver_yamaha ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/bin/sensorstatutil_yamaha ../../../vendor/samsung/$DEVICE/proprietary
adb pull /system/lib/hw/sensors.default.so ../../../vendor/samsung/$DEVICE/proprietary
